...
public class ClasspathPackageScanner implements PackageScanner {
    ...
    private List<String> doScan(String basePackage, List<String> nameList) throws IOException {
        ...
        String splashPath = S.path.dotToSplash(basePackage);
 
        // get file path
        URL url = cl.getResource(splashPath);
        String filePath = S.path.getRootPath(url);
        ...
        for (String name : names) {
            if (isClassFile(name)) {
                //nameList.add(basePackage + "." + S.trimExtension(name));
    ...
    private String toFullyQualifiedName(String shortName, String basePackage) {
        ...
        sb.append('.');
        sb.append(S.path.trimExtension(shortName));
    ...
    public static void main(String[] args) throws Exception {
        PackageScanner scan = new ClasspathPackageScanner("org.zsl.core");
        List<String> fullyQualifiedClassNameList = scan.getFullyQualifiedClassNameList();
       // fullyQualifiedClassNameList.forEach(path->System.out.println(path));
    }
}
